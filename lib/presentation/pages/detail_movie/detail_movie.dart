...
import '../../widgets/tabs/widgets/index.dart';
                        ...
                        ? Column(
                            children: <Widget>[
                              HeaderDetail(
                                ...
                                imagePoster:
                                    'https://image.tmdb.org/t/p/w185${controller.movie!.posterPath ?? ""}',
                                rating: double.parse(
                                    controller.movie!.voteAverage ?? "0"),
                                genre: controller.movie?.genres
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              SizedBox(
                width: ((size.width - (_detailTabs.length - 1 * 15)) /
                        _detailTabs.length) -
                    44,
                height: 50,
