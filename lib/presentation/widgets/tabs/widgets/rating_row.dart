        ...
        onTap: () async {
          ...
          if (isMovie) {
            final Response<dynamic> response =
                await controller.detailRepository.rateMovie(
              id,
              <String, dynamic>{
            ...
            if (response.statusCode == 201) {
              ...
              Get.snackbar("Success",
                  "You voted ${controller.rate.value} for this ${isMovie ? "movie" : "tv series"}");
            }
          }
        },
        child: Icon(
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Obx(
                    () => Text(
                      controller.isRatedApi.value
                          ? "Vote: ${controller.rate.value}"
                          : "details.grade".tr,
                      style: const TextStyle(
                        fontWeight: FontWeight.w400,
                        color: Colors.white,
