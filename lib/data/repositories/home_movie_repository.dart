...
abstract class IHomeMovieProvider {
  Future<Response<MovieWrapper>> getNowPlayingMovie(
      {required String path, Map<String, dynamic>? query});

  Future<Response<MovieWrapper>> getPopularMovie(
      {required String path, Map<String, dynamic>? query});

  Future<Response<MovieWrapper>> getTopRatedMovie(
      {required String path, Map<String, dynamic>? query});

  Future<Response<MovieWrapper>> getUpcomingMovie(
      {required String path, Map<String, dynamic>? query});
}
...
class HomeMovieProvider extends BaseProvider implements IHomeMovieProvider {
  ...
  InternalFinalCallback<void> get onStart {
    httpClient.defaultDecoder =
        (dynamic val) => MovieWrapper.fromJson(val as Map<String, dynamic>);
...
class HomeMovieRepository extends BaseRepository<HomeMovieProvider>
    implements IHomeMovieRepository {
  HomeMovieRepository() : super(provider: HomeMovieProvider());

  @override
  Future<MovieWrapper?> getNowPlayingMovie(
      {Map<String, dynamic>? query}) async {
    final Response<MovieWrapper> response = await provider.getNowPlayingMovie(
        path: Url.nowPlayingMovies, query: query);
  ...
  Future<MovieWrapper?> getPopularMovie({Map<String, dynamic>? query}) async {
    final Response<MovieWrapper> response =
        await provider.getPopularMovie(path: Url.popularMovies, query: query);
  ...
  Future<MovieWrapper?> getTopRatedMovie({Map<String, dynamic>? query}) async {
    final Response<MovieWrapper> response =
        await provider.getTopRatedMovie(path: Url.topRatedMovies, query: query);
  ...
  Future<MovieWrapper?> getUpcomingMovie({Map<String, dynamic>? query}) async {
    final Response<MovieWrapper> response =
        await provider.getUpcomingMovie(path: Url.upcomingMovies, query: query);
